%Software
In this section we describe the software implementing ballot polling audits, termed the R2B2 library, and the simulator software. All the software is released as open source under the MIT License.
