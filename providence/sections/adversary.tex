...
% To see the practical implication of this result, we consider a toy example: an RLA of a two-candidate contest with margin $10\%$ and risk limit $10\%$. 
% Suppose a first round of $100$ ballots is drawn and $60$ ballots in the sample are votes for the announced winner. Since $\tau_1(k,p_a,p_0,\ldots$...
