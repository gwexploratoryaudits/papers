...
R2B2 contains software to test stopping conditions and find round sizes for given probability of stopping and probability of a \emph{misleading sample}. Also the code for simulations and workload and real time analysis are provided.
