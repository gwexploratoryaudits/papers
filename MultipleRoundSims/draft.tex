...
\begin{abstract}
    ...
    \Minerva is a recently proposed ballot polling RLA that requires fewer ballots than either implementation of \BRAVO in the first round but requires a predetermined round schedule.
