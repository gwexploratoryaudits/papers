...
\caption{The average and $0.25$ and $0.75$ quantiles for total number of ballots sampled, as a function of $p$, the conditional stopping probability used to select each round size, for ballot polling audits of the 2016 US Presidential election in the US State of Virginia. For sufficiently large $p$ ($p\ge 0.75$), the $0.25$ and $0.75$ quantiles are both equal to the first round size, and this shown by the downward arrows.}
\label{fig:avg_bals}
\end{figure}
