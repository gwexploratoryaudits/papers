...
In Figure~\reg{fig:misleading}, a horizontal line is included to illustrate the implication of a small \emph{misleading limit} of $0.1$.
...
\begin{figure}
\includegraphics[width=.5\textwidth]{optima_with_precinct_cost.png}
