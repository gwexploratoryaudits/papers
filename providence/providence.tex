...
The most commonly used ballot polling RLA, \BRAVO (Stark), requires the fewest ballots when each round is just one ballot. 
Recent RLA \Minerva draws signficantly fewer ballots than \BRAVO for larger round sizes but requires the round schedule to be fixed before the audit begins.
