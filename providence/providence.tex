...
In R2B2, we provide software to test stopping conditions, find round sizes for given probability of stopping, and find round sizes for given probability of a \emph{misleading sample}. The software includes the simulator and the functionality to perform the workload and real time analysis we present in this paper.
