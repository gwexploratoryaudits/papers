...
\hline
\end{tabular}
\caption{A simulation of a \Providence audit of a tied contest with an announced margin of 0.0566, and $\alpha=0.1$. Each round size is computed for a conditional stopping probability of $0.9$. The stopping condition is Inverse Ratio $\le \alpha$.}
\label{tab:toy}
\end{table}
