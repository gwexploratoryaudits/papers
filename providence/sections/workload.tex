...
So for an audit with expected number of ballots $E_{b}$ and expected number of rounds $E_{r}$, we estimate that the workload $C$ of the audit is
\begin{equation}
W(E_b,E_r) = E_b w_b + E_r w_r
...
\begin{equation}
W(E_b, E_r, E_p) = E_b w_b + E_r w_r + E_p w_p
