...
Audits going towards statutory or legal requirements would need to be completed by the certification deadline\footnote{Pilot audits, performed after certification, usually end after a single round or fixed number of rounds, providing a measured risk (the statistical p-value) at the end of the round, and no decision regarding a full hand count needs to be made.}; this provides an incentive to go to a hand count. It is worth considering bring back a small value of $\beta$ into the stopping condition, or requiring election officials to declare beforehand when they would stop drawing ballots and go to a full hand count. 
