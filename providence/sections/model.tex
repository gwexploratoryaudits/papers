...
A manual hand count presents significant logistical challenges. Left to election officials, the decision would be influenced by the certification deadline, the estimated number of human hours required for another round, the logistical costs of a full hand count, and the impact of any decision on citizen confidence. The only disadvantage of leaving the decision to election officials would be when the outcome were incorrect, and election officials would continue drawing rounds hoping that they would not need to escalate to a full hand count. Audits going towards statutory or legal requirements would need to be completed by the certification deadline; this provides an incentive to go to a hand count. Pilot audits, performed after certification, usually end after a single round or fixed number of rounds, providing a measured risk (the statistical p-value) at the end of the round, and no decision regarding a full hand count needs to be made. A better workload model would enable a better determination of when election officials are better off stopping than drawing more ballots 
