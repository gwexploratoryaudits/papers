...
\label{sec:ack}
The authors are grateful to the Rhode Island Board of Elections for conducting a pilot \Providence RLA. The authors thank Georgina Cannan for insightful comments.
...
% Following each round, a decision is taken whether to end the audit, declaring it successful and the election correct, or to draw another round of ballots. The votes would be fully hand counted after multiple unsuccessful rounds. 
