...
Our implementation of \Providence and audit planning tools in the open source R2B2 library has been integrated as an option in Arlo, the most commonly used RLA software.
