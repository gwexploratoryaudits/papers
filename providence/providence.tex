...
\author{
{\rm Oliver Broadrick$^1$\thanks{odbroadrick@gmail.com}, Poorvi L. Vora$^1$, and Filip Zag{\'o}rski$^{23}$}\thanks{Author was partially supported by Polish National Science Centre contract number
DEC-2013/09/D/ST6/03927}\\
odbroadrick@gmail.com\\
$^1$
Department of Computer Science, The George Washington University\thanks{Authors supported in part by NSF Award 2015253}\\
$^2$
...
\label{sec:ack}
The authors are grateful to the Rhode Island Board of Elections for conducting a pilot \Providence RLA. The authors thank Georgina Cannan, Liz Howard, Mark Lindeman, and John Marion for their support. The authors are grateful to Audrey Malagon for helpful conversation.
